...
const translations = {
  ...
  ru: {
    ...
    hero: {
      ...
      title: "Персональный психолог в твоем кармане",
      ...
      <footer className="py-20 bg-gray-900 text-white">
        <div className="container max-w-6xl mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2025 MindMate. {language === 'en' ? 'All rights reserved.' : language === 'pt' ? 'Todos os direitos reservados.' : 'Все права защищены.'}</p>
          </div>
        </div>
      </footer>
    </div>
